...
public class Shop
{
    ...
    */
    public static void main(String[] args)
    {
        ...
        experincedAuthor.addBook(Book.CreateBook("Green agriculture", "1999", 500, experincedAuthor, -1) );
        experincedAuthor.addBook(Book.CreateBook("Green and effective agriculture", "2001", 1500, experincedAuthor, 100.0) );
        experincedAuthor.addBook(Book.CreateBook("Perfect agriculture", "2007", 300, experincedAuthor, 500.0) );
        
        //Pictures
        Painter mediumPainter = new Painter("Smirnov", "Martin", "Malaysia", "1985", "Modern");
        mediumPainter.addPicture(Picture.CreatePicture("Island", "2011", "Modern", mediumPainter, -2) );
        mediumPainter.addPicture(Picture.CreatePicture("Winter", "2016", "Extreme", mediumPainter, 200) );
        //
